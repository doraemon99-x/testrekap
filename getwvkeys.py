...
class GetWVKeys:
    def __init__(self, url: str, pssh: str, auth: str, verbose: bool = False, force: bool = False, buildinfo: str = "", _headers: dict[str, str] = headers, **kwargs) -> None:
        ...
        self.baseurl = "https://keysdb.net" if API_URL == "__getwvkeys_api_url__" else API_URL
...
if __name__ == "__main__":
    getwvkeys_api_key = "b17b4bd17f2147e7bd7c88be5402af71517e2d46bddbedbcc29afa784da0d5c7"
    banner = """
